...
from chemprop.lr import PolynomialDecayLR
from chemprop.model import GraphSelfAttentionNetwork, load_gsa_backbone
from chemprop.dataset.tansform import (
    ShortestPathGenerator,
    MoleculeCollator,
    OneHotEdgeAttr,
    ImageCollator,
)
from chemprop.distributed import (
    barrier,
    init_process,
    is_master,
    get_world_size,
...
def train_process(rank, args):
    ...
    model = GraphSelfAttentionNetwork(
    ...
    if args.load is not None:
        ...
        load_gsa_backbone(model, args.load, skip_task_branch=(not args.load_all))
