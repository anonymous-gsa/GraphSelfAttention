...
def load_gsa_backbone(model, load, skip_task_branch=True, map_location="cpu"):
    new_dict = {}
...
class MultiHeadAttention(nn.Module):
    ...
    def forward(
        ...
        query_context_bias = query_hop + query_edge
        key_context_bias = key_hop + key_edge

        x = torch.matmul(q, k.transpose(2, 3)) + query_context_bias + key_context_bias
